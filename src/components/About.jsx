    ...
    return (
        <div className='flex w-full  justify-center p-5 flex-col'>
            ...
            <div className="flex items-center justify-center flex-wrap abt1 gap-7">
                ...
                <div style={{width:'45%'}} className="flex  flex-col gap-5">
            ...
            <div className="flex items-center p-3 justify-center mt-10 mb-10 w-full ">
                <div style={{ width: '55%' }} className="flex abt1 border items-center gap-7 flex-col  relative shadow-2xl p-2">
                    <img className="h24 w-24 left-96  absolute" src="https://st.depositphotos.com/1168906/1419/v/950/depositphotos_14193017-stock-illustration-red-darts-target-aim-and.jpg" alt="" />
                    <h1 className="text-pink-700 text-3xl pt-10">Our Mission & Vision</h1>
                    <p className="w-full text-lg">
                        Our aim is to provide Flexible Supported Living services with a focus on
                        the service users.
                        Top-Notch Healthcare services aim to provide regulated activities of
