...
const Categories = () => {
    return (
        <div className='flex flex-col cat justify-start items-start bg-yellow-50 gap-20 w-full p-10'>
            <h1 className="text-2xl">Types of live care</h1>
            <p className='text-lg'>Aside from companionship and general support  we typically see 4 different types of live care needs</p>
